...
_CREATEPOSTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='conversationTitle', full_name='kittens.post.CreatePostRequest.conversationTitle', index=2,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REPLIESREQUEST = _descriptor.Descriptor(
  name='RepliesRequest',
  full_name='kittens.post.RepliesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='postId', full_name='kittens.post.RepliesRequest.postId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shallow', full_name='kittens.post.RepliesRequest.shallow', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='watch', full_name='kittens.post.RepliesRequest.watch', index=2,
...
DESCRIPTOR.message_types_by_name['RepliesRequest'] = _REPLIESREQUEST
...
RepliesRequest = _reflection.GeneratedProtocolMessageType('RepliesRequest', (_message.Message,), dict(
  DESCRIPTOR = _REPLIESREQUEST,
  __module__ = 'post_pb2'
  # @@protoc_insertion_point(class_scope:kittens.post.RepliesRequest)
  ))
_sym_db.RegisterMessage(RepliesRequest)
...
_POSTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Replies',
    full_name='kittens.post.Posts.Replies',
    index=2,
    containing_service=None,
    input_type=_REPLIESREQUEST,
    output_type=_POST,
    serialized_options=None,
  ),
])
